export default function HeroSection() {
    return (
        <section className="hero">
            ...
            <div className="hero-media" aria-label="Group photo placeholder">
                <div className="hero-image-placeholder">
                    <span>Group image placeholder</span>
                </div>
            </div>
        </section>
    );
